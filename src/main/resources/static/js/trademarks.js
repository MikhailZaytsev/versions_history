...
colReorder: true,
    ...
    "columnDefs": [
        ...
        } ,
       {
        ...
        '<i class="fa fa-pencil"></i></a> <a href="/trademarks/delete?id='+data+'" class="pl-1 pr-3" role="button" onclick="pressed(this);" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></a>'+data;},
        targets: [0]
        }
        ]
